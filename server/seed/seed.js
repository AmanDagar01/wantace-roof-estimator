...
const seedDatabase = async () => {
    try {
       ...
       * This keeps the seed script repeatable during development.
       */
       ...
       */
      await Lead.insertMany(historicalLeads);
